...
- **Team Name**: C401 - C5
- **Team Members**: Đỗ Minh Phúc, Nguyễn Minh Hiếu, Hồ Sĩ Minh Hà, Nguyễn Khánh Nam, Lê Tú Nam, Lê Hữu Hưng
...
Trong quá trình phát triển Agent v1, nhóm phát hiện và phân tích **4 lỗi nghiêm trọng** thông qua telemetry logs, sau đó xây dựng Agent v2 với các bản vá tương ứng.
...
- **Fix**: Thêm rule vào system prompt cấm dùng quotes; thêm `.replace('"', '')` khi parse tool_args. Thêm fallback sử dụng Duckduckgo
